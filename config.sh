...
export KERNEL_VERSION_MINOR="12.8"
...
export GLIBC_FILENAME_SIG="${GLIBC_FILENAME}.sig"
export GLIBC_URL_SIG="${GLIBC_URL}.sig"
export GLIBC_TARBALL_SIG="${GLIBC_TARBALL}.sig"
